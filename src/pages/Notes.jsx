...
function Notes({ notes }) {
  ...
  return (
    <div className='w-full bg-gray-400 flex justify-center min-h-screen'>
      <div className='note-body bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark px-4 w-[390px] flex flex-col gap-5 transition-colors duration-300'>
        ...
        <section className="grid grid-cols-1 gap-2">
          {filteredNotes.length === 0 && <p className="empty__notes text-xl text-red-500 font-extrabold">No notes found ...</p>}
